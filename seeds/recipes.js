  ...
  return knex('recipes').del()
    .then(function () {
      ...
      return knex('recipes').insert([
        ...
        {id: 9, name: 'Adult Butterbeer', description: 'dAlthough the butterbeer in the books isnt alcoholic, that shouldnt stop you from splashing a little booze in your next batch', tags: ''},
